...
class Jugador(pygame.sprite.Sprite):  #Classe de pygame para los sprite
    ...
    def __init__(self):
        ...
        self.image=pygame.transform.scale(self.image,(200,200)).convert() #Cargamos imagen y con .convert() mejoramos el rendimiento optimizando la imagen
        self.rect=self.image.get_rect()
        
        
        self.rect.center=(ANCHO//2,ALTO//2) #Modificar para cambiar posicion inicial jugador(ANCHO,ALTO)
