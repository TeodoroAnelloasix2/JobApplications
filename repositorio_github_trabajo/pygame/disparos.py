...
class Disparos(pygame.sprite.Sprite):
    def __init__(self,x,y):
        super().__init__()
        self.image=pygame.transform.scale(pygame.image.load("/home/teodoro_root/python/pygame/data/images/projectile.png").convert(),(10,20))
        self.image.set_colorkey((0,0,0))
        self.rect=self.image.get_rect()
        self.rect.bottom=y
        self.rect.centerx= x
...
while True:
    ...
    colision_p=pygame.sprite.spritecollide(jugador,enemy2,False) #Mirar bien spritecollide Basicamente implementa colisiones 
